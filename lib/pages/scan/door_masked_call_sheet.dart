...
import '../../services/door_tag_service.dart';
import '../../services/auth_service.dart';
import '../../providers/location_provider.dart';
import 'masked_call_result_sheet.dart';

class DoorMaskedCallSheet extends StatefulWidget {
  final String doorTagId;
  final String? phoneNumber;

  const DoorMaskedCallSheet({
    super.key,
  ...
  @override
  State<DoorMaskedCallSheet> createState() => _DoorMaskedCallSheetState();
  ...
  static void show(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => DoorMaskedCallSheet(
        doorTagId: doorTagId,
...
class _DoorMaskedCallSheetState extends State<DoorMaskedCallSheet> {
  ...
  Future<void> _loadUserPhone() async {
    try {
      ...
      if (phoneNumber != null && mounted) {
        ...
        print('📞 [DoorMaskedCallSheet] Phone autofilled: $phoneNumber');
      }
    } catch (e) {
      print('❌ [DoorMaskedCallSheet] Error loading user phone: $e');
    }
  }
  ...
  Future<void> _setupMaskedCall() async {
    ...
    try {
      ...
      final response = await DoorTagService.notifyOwnerForCall(
        ...
        if (response.status == 'success') {
          ...
          if (response.maskedNumber != null && response.maskedNumber!.isNotEmpty) {
            ...
            MaskedCallResultSheet.show(
              context,
              vehicleNumber: widget.doorTagId,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Please provide your phone number to notify the door owner.',
                      style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: _isLoading
                            ...
                            : Icon(Icons.phone),
                        label: Text(
                          _isLoading ? 'Notifying...' : 'Notify Door Owner',
                          style: TextStyle(
