...
class LoginPinService {
  ...
  static Future<bool> checkPin({required String phone}) async {
    try {
      ...
      final url = Uri.parse('$_baseUrl/check_login_pin_api');
      ...
      if (response.statusCode == 200) {
        ...
        // Check status and extract has_pin from data
      ...
      throw Exception('Error checking PIN: $e');
    }
  }
  ...
  static Future<Map<String, dynamic>> setPin({
    ...
    try {
      ...
      final url = Uri.parse('$_baseUrl/add_login_pin_api');
      print('🔵 Making request to: $url');
      print('🔵 Body parameters:');
      print('   - phone: $phone');
